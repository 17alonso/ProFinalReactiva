<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescripcionProducto.aspx.cs" Inherits="ReactivaPeru.DescripcionProducto" %>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">	
							...
							<p class="text-white link-nav"><a href="backpacker.html">Empresas </a>  <span class="lnr lnr-arrow-right"></span>   Textuir</p>
						</div>	
					</div>
				</div>
			</section>
                ...
                <div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center" runat="server" id="txtdiv">
											<!-- aqui hay codido-->			
