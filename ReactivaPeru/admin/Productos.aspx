<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Productos.aspx.cs" Inherits="ReactivaPeru.admin.Productos" %>
						...
						<div class="col-lg-8 posts-list">							 
							<div class="single-post row">
								...
								<div class="col-lg-3  col-md-3 meta-details">
									...
									<asp:GridView runat="server" ID="gvProducto" class="table table-striped">
				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-6 reservation-left">
							<h1 class="text-white">Ingrese Nuevos Productos</h1>
							<p class="text-white pt-20">
							Amplie su catalogo con sus productos nuevos!</p>
							<!--
						...
						<div class="col-lg-5 reservation-right">
							<div class="form-wrap text-center" >
								...
								<asp:TextBox runat="server"  class="form-control" type="text" placeholder="Cod Producto" id="txtCodProd"/>

								
								<asp:TextBox runat="server"  class="form-control" type="text" placeholder="Cod Categoria" id="txtCodCat"/> 

								
								<asp:TextBox runat="server"  class="form-control" type="text" placeholder="Nombre del Producto" id="txtNom"/> 
								
                                <asp:FileUpload class="form-control" ID="imag" accept=".jpg" runat="server" />
								
								
								<asp:TextBox runat="server"  class="form-control" type="text" placeholder="Marca del Producto" id="txtMarca"/> 
								<asp:TextBox runat="server"  class="form-control" type="text" placeholder="Stock" id="txtStock"/> 
								<asp:TextBox runat="server"  class="form-control" type="text" placeholder="Precio" id="txtPrecio"/> 

								<asp:TextBox runat="server" rows="6" cols="50" class="form-control" type="text" placeholder="Descripcción del Producto" id="txtDescrip"/> 
								...
								<asp:Button Text="Actualizar" runat="server"  class="btn btn-outline-primary" id="btnActualizar" OnClick="btnActualizar_Click" />																				
							</div>
						</div>
					</div>
				</div>	
