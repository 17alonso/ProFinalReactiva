<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Boleta.aspx.cs" Inherits="ReactivaPeru.Intranet.Boleta" %>
                ...
                <div class="row">
                    <form id="form2" runat="server">
                        ...
                        <div class="container" >
                            ...
                            <p>
                                <asp:Button Text="Agregar Boleta" runat="server" Id="btnAgregarBoleta" class="btn btn-primary" ValidationGroup="A"  />
                                <asp:Button Text="Agregar Detalle" runat="server" Id="btnAgregarDetBoleta"  class="btn btn-primary" ValidationGroup="B"  />
