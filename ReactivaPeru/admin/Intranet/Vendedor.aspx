<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vendedor.aspx.cs" Inherits="ReactivaPeru.Intranet.Vendedor" %>
     ...
     <div class="navbar navbar-dark bg-dark box-shadow">
        ...
        <main role="main">
            <section class="jumbotron text-center">
                            <h1 class="jumbotron-heading">CRUD Vendedor</h1>
                         </section>
             <div class="container">
                <div class="row">
                        ...
                        <div class="container" >
                            ...
                            <div class="row">
                                ...
                                <label for="exampleInputEmail1">Codigo Vendedor:
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtIdCodigoVendedor" ErrorMessage="RequiredFieldValidator" ForeColor="#FF3300" ValidationGroup="A">*</asp:RequiredFieldValidator>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtIdCodigoVendedor" ErrorMessage="RequiredFieldValidator" ForeColor="#FF3300" ValidationGroup="B">*</asp:RequiredFieldValidator>
                                                                   
                                </label>
                                <asp:TextBox runat="server" Id="txtIdCodigoVendedor" class="form-control"  placeholder="Codigo Vendedor" style="width:400px"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row">
                                ...
                                <label for="exampleInputEmail1">Contraseña: 
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtContraseña" ErrorMessage="RequiredFieldValidator" ForeColor="#FF3300" ValidationGroup="A">*</asp:RequiredFieldValidator>

                                </label>
                                    <asp:TextBox runat="server" Id="txtContraseña" class="form-control" placeholder="Contraseña" style="width:400px"/>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive"> 
                                <asp:GridView runat="server" ID="gvVendedor" CssClass="table table-hover"></asp:GridView>
                                </div>
