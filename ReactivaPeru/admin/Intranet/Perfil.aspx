<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Perfil.aspx.cs" Inherits="ReactivaPeru.Intranet.Perfil" %>
                        ...
                        <form runat="server">
                           ...
                           <!-- 
                            <div class="form-group">
                               ...
                               --> 
                                <asp:Button Text="Entrar" runat="server" Id="btnEntrar" class="btn btn-primary"  />
                            <br/>
                            <br/>
                            <br/>
