...
namespace ReactivaPeru.Intranet
{
    public partial class Inicio : System.Web.UI.Page
    {
        ...
        {
            Response.Write("<script>window.location = 'Administrador.aspx';</script>");

        }

        protected void btnEmpresa_Click(object sender, EventArgs e)
        {
            Response.Write("<script>window.location = 'Empresa.aspx';</script>");
        }

        protected void btnImagen_Click(object sender, EventArgs e)
        {
            Response.Write("<script>window.location = 'Imagen.aspx';</script>");
        }

        protected void btnDetalleProducto_Click(object sender, EventArgs e)
        {
            Response.Write("<script>window.location = 'DetalleProducto.aspx';</script>");
        }
    }
}