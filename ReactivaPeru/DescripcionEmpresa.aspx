<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescripcionEmpresa.aspx.cs" Inherits="ReactivaPeru.DescripcionEmpresa" %>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Textuir</h1>
								<p>Empresa de textiles</p>

									<p>Precio: <b>S/.<?php echo $pre?></b></p>
							</div>
						</div>
					</div>	
