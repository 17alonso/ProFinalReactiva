<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Catalogo.aspx.cs" Inherits="ReactivaPeru.Catalogo" %>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="#">Catalogo </a>  <span class="lnr lnr-arrow-right"></span>  <a href="#"> Productos</a></p>
						</div>	
					</div>
				</div>
			</section>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Catálogo de Productos</h1>
								<p>Escoja entre nuestra ampli varidad de productos ofrecidas por nuestras empresas registradas!</p>
							</div>
						</div>
					</div>					
					<div class="row" runat="server" id="idDivProdutos">

						<!-- Aqui se ingresan datos-->
